...
will do this job.
If you want deploy all BAP services in one VM, in the section **4. Deploy the platform** you have to run [all_in_one.yml](/docs/deployment_and_config.md#deploy-all-bap-services-in-a-single-vm-optional) playbook.
...
Instead of run `all.yml` playbook you should run `all_in_one.yml`.
